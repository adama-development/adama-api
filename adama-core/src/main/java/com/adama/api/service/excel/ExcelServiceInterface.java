...
public interface ExcelServiceInterface {
    ...
    /**
     * Create Excel file from object list, need the entity of the object in the list
     * 
     * @param objectList
     * @param entityType
    ...
    /**
     * Read Excel file and if no id will create a new object, if have id it will update the object of entity type
     * 
     * @param inputStream
     * @param entityType
     * @param service
